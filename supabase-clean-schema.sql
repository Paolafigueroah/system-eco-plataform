-- Script de limpieza completa para Supabase
...
-- Políticas de puntos de usuario
DROP POLICY IF EXISTS "Users can view their own points" ON user_points;
DROP POLICY IF EXISTS "Users can create their own points" ON user_points;
...
-- Crear trigger para actualizar contador de favoritos
